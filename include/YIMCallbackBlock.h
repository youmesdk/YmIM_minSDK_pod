...
typedef void(^sendMessageStatusCBType)(YIMErrorcodeOC errorcode, unsigned long long sendTime, bool isForbidRoom,int reasonType,unsigned long long forbidEndTime,unsigned long long messageID,NSString* filePath,NSString* fileURL);
typedef void(^uploadProgressCBType)(float percent);
typedef void(^sendAudioMsgStatusCBType)(YIMErrorcodeOC errorcode, NSString* text, NSString* audioPath, unsigned int audioTime, unsigned long long sendTime, bool isForbidRoom, int reasonType, unsigned long long forbidEndTime,unsigned long long messageID,NSString* fileURL);
